...
#
filenamesuffix="lowsigmaeps"

# Define your parameter grid
τb_vals = collect(range(0.20, stop=0.7, length=10))
ρ_τ_vals = [0.0]
...
OCM_old.Nit = 500
OCM_old.inewt=0
rguess,trguess= 0.038, 0.5
OCM_old.rlb=rguess*.8
OCM_old.rub=rguess*1.2
OCM_old.trlb =trguess*.8
OCM_old.trub =trguess*1.2
OCM_old.r=rguess
OCM_old.tr=trguess
