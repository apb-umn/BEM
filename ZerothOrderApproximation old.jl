...
@with_kw mutable struct DerivativesF
    ...
    ayᵉ::Vector{Array{Float64,3}}    =  [zeros(1,1,1)]
    xx::Vector{Array{Float64,3}}    =  [zeros(1,1,1)]
    xX::Vector{Array{Float64,3}}    =  [zeros(1,1,1)]
    xyᵉ::Vector{Array{Float64,3}}   =  [zeros(1,1,1)]
    Xx::Vector{Array{Float64,3}}    =  [zeros(1,1,1)]
    XX::Vector{Array{Float64,3}}    =  [zeros(1,1,1)]
    Xyᵉ::Vector{Array{Float64,3}}   =  [zeros(1,1,1)]
    yᵉx::Vector{Array{Float64,3}}    =  [zeros(1,1,1)]
    yᵉX::Vector{Array{Float64,3}}    =  [zeros(1,1,1)]
    yᵉyᵉ::Vector{Array{Float64,3}}  =  [zeros(1,1,1)]
end
